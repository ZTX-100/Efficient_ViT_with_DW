...
# ViT-B parameters
_C.MODEL.ViT_B = CN()
_C.MODEL.ViT_B.PATCH_SIZE = 16
_C.MODEL.ViT_B.DIM = 768
_C.MODEL.ViT_B.DEPTHS = 12
_C.MODEL.ViT_B.NUM_HEADS = 12
_C.MODEL.ViT_B.MLP_DIM = 3072
_C.MODEL.ViT_B.DIM_HEAD = 768 // 12

# ViT-L parameters
_C.MODEL.ViT_L = CN()
_C.MODEL.ViT_L.PATCH_SIZE = 16
_C.MODEL.ViT_L.DIM = 1024
_C.MODEL.ViT_L.DEPTHS = 24
_C.MODEL.ViT_L.NUM_HEADS = 16
_C.MODEL.ViT_L.MLP_DIM = 4096
_C.MODEL.ViT_L.DIM_HEAD = 1024 // 16
...
# CaiT parameters
_C.MODEL.CaiT_XS = CN()
_C.MODEL.CaiT_XS.PATCH_SIZE = 16
_C.MODEL.CaiT_XS.DIM = 288
_C.MODEL.CaiT_XS.DEPTHS = 12
_C.MODEL.CaiT_XS.CLS_DEPTHS = 2
_C.MODEL.CaiT_XS.NUM_HEADS = 6
_C.MODEL.CaiT_XS.MLP_DIM = 288 * 4
_C.MODEL.CaiT_XS.DIM_HEAD = 288 // 6


# CaiT parameters
_C.MODEL.CaiT_S = CN()
_C.MODEL.CaiT_S.PATCH_SIZE = 16
_C.MODEL.CaiT_S.DIM = 384
_C.MODEL.CaiT_S.DEPTHS = 12
_C.MODEL.CaiT_S.CLS_DEPTHS = 2
_C.MODEL.CaiT_S.NUM_HEADS = 8
_C.MODEL.CaiT_S.MLP_DIM = 384 * 4
_C.MODEL.CaiT_S.DIM_HEAD = 384 // 8
